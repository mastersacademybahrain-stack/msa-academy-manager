...
export default async function(req,res){
 const {sport,day_of_week,start_time,coach_id=null,coach_ids=[],start_date,replicate=false,end_date=null,tennis_categories=[]}=req.body||{};
 ...
 const x=await db.query('INSERT INTO academy_sessions(sport,day_of_week,start_time,coach_id,start_date,end_date,tennis_categories) VALUES($1,$2,$3,$4,$5,$6,$7) RETURNING id,sport,day_of_week,start_time,coach_id,start_date,end_date,tennis_categories',[sport,+day_of_week,start_time,primaryCoach,start_date,ed.toISOString().slice(0,10),cats]);

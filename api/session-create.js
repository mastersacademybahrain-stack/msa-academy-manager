...
export default async function(req,res){
 ...
 const categoryMap={Tennis:['Red','Orange','Green','Yellow','Veteran','Private'],Swimming:['Kids','Juniors','Adults','Private'],'Water Polo':['Kids','Teens','Veterans','Private'],Padel:['Kids','Teens','Veterans','Private'],Taekwondo:['Kids','Teens','Private'],Fitness:['Kids','Juniors','Private']};
 ...
 // Session categories are optional when creating a schedule. A session may be created without a category and can be categorized later.

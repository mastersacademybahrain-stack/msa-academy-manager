...
export default async function(req,res){
 ...
 const categoryMap={Tennis:['Red','Orange','Green','Yellow','Veteran'],Swimming:['Kids','Teens','Veterans'],'Water Polo':['Kids','Teens','Veterans'],Padel:['Kids','Teens','Veterans'],Taekwondo:['Kids','Teens'],Fitness:['Kids','Juniors']};

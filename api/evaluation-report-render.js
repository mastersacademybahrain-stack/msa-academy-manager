...
export default async function(req,res){
  ...
  '.photo{position:absolute;left:0;top:0;width:210mm;height:131mm;background:#eaf2f8;overflow:hidden}.option2-photo{position:absolute;inset:0;display:block;width:100%;height:100%;object-fit:fill;object-position:center center}.report-logo{position:absolute;top:7mm;right:8mm;width:25mm;height:25mm;object-fit:contain;z-index:4;filter:drop-shadow(0 1mm 1.5mm rgba(0,0,0,.28))}'+
  '.panel{position:absolute;left:8mm;right:8mm;top:128mm;z-index:10;background:rgba(255,255,255,.985);border-radius:5mm;box-shadow:0 3mm 10mm rgba(0,38,86,.18);padding:6mm 7mm 5mm}'+

...
export default async function(req,res){
  ...
  '.photo{position:absolute;left:0;top:0;width:210mm;height:128mm;background:#eaf2f8;overflow:hidden}.option2-photo{display:block;width:100%;height:100%;object-fit:cover;object-position:center center}'+
  ...
  '.levelcard{position:absolute;right:7mm;top:5mm;width:72mm;height:38mm;border:.5mm solid var(--level);border-radius:4mm;background:var(--levelsoft);z-index:12;display:grid;grid-template-columns:35mm 1fr;align-items:center;padding:3mm}.ball{width:29mm;height:29mm;border-radius:50%;object-fit:cover;box-shadow:0 1mm 3mm rgba(0,0,0,.22);display:block}.levelname{font-size:5mm;font-weight:1000;color:var(--level);line-height:1}.leveltag{font-size:2.6mm;font-weight:900;color:#16396b;margin-top:2mm}.leveldesc{font-size:2.5mm;font-weight:800;color:#16396b;margin-top:2mm;line-height:1.1}'+
  ...
  '</style></head><body><div class="page"><div class="photo">'+(hero?'<img class="option2-photo" src="'+hero+'" alt="Selected '+esc(sport)+' Option 2">':'')+'</div>'+

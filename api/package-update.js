...
export default async function(req,res){
 ...
 const {id,name,sport,sessions_per_week,duration_weeks,price,package_type,start_date,end_date}=req.body||{};
 ...
 const r=await db.query('UPDATE packages SET name=$1,sport=$2,sessions_per_week=$3,duration_weeks=$4,price=$5,package_type=$6,start_date=$7,end_date=$8 WHERE id=$9 RETURNING id,name,sport,sessions_per_week,duration_weeks,price,package_type,start_date,end_date,active',[name,sport,sessions,weeks,price===undefined||price===''?null:+price,type,start_date||null,end_date||null,id]);
